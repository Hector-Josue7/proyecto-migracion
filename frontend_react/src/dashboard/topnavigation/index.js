        ...
        <div className="flex items-center pl-1 relative w-full sm:ml-0 sm:pr-2 lg:max-w-68">
          <div className="container flex left-0 relative w-3/4">
            ...
            <div className="group h-full hidden items-center relative w-full md:flex lg:w-64">
              <div className="absolute block cursor-pointer flex items-center justify-center p-3 pr-2 text-gray-500 text-sm uppercase sm:hidden">
                <svg
                  fill="none"
              ...
              <input
                ...
                placeholder="Search"
              />
              <div className="absolute border border-gray-300 h-auto hidden mr-2 px-2 py-1 right-0 text-gray-400 text-xs rounded-2xl md:block">
                +
              </div>
            </div>
          </div>
          <div className="flex items-center justify-end ml-5 p-1 relative w-9/12 sm:mr-0 sm:right-auto md:w-1/4">
            ...
            <a
              href="#"
              className="block inline-block px-3 py-2 relative rounded text-white"
            >
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <span className="absolute bg-blue-700 font-bold px-2 py-0.5 right-0 rounded-full text-xs top-0">
                3
              </span>
            </a>
